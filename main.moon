...
juno.onLoad = (dt) ->
  ...
  table.insert(G.background,npc({1,0,0},50,"Mr.Red",G.canvas,G.vec2.vec2(15,19),8,8,false))
  table.insert(G.background,npc({0,0,1},"Mr.Blue",G.canvas,G.vec2.vec2(24,13),8,8,false))
  table.insert(G.foreground,player({0,1,0},"Josh",G.canvas,G.vec2.vec2(0,16),8,8,false))
  return 0
